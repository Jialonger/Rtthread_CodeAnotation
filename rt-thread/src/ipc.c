 ...
 *
 * Anotation：初始化 ipc_object 也就是构成一个双向的环形的对象链表
 */
...
/**
 * This function will suspend a thread to a specified list.
 * IPC object or some double-queue object (mailbox etc.) contains this kind of list.
 *
